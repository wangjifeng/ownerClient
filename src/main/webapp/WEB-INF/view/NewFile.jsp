...
<body>
			...
			<h1>待认证用户添加用户信息进行用户认证</h1>
			<form action="http://localhost:8080/ownerClient/api/lawyer/addOwner.shtml" method="post">
				<input name="token" value="99cd099a977d4a398bde7865aae6c31e"><br/>
				用户UID：<input name="uid" value="688046581"><br/>
				名称：<input name="name" value="刘武"><br/>
				电话：<input name="mobile" value="18754203654"><br/>
				身份证号：<input name="idCard" value="510623199209170712"><br/>
				身份证前大图：<input name="pictureFrontBig" value="jsfasl/kjalsdkja/adjsa.jpg"><br/>
				身份证后大图：<input name="pictureBackBig" value="jsfasl/kjalsdkja/adjsa.jpg"><br/>
				身份证前小图：<input name="pictureFrontSmall" value="jsfasl/kjalsdkja/adjsa.jpg"><br/>
				身份证后小图：<input name="pictureBackSmall" value="jsfasl/kjalsdkja/adjsa.jpg"><br/>
				房产证大图：<input name="housePropertyBig" value="jsfasl/kjalsdkja/adjsa.jpg"><br/>
				房产证小图：<input name="housePropertySmall" value="jsfasl/kjalsdkja/adjsa.jpg"><br/>
				住房面积：<input name="area" value="120"><br/>
				小区名称：<input name="communityName" value="平安小区"><br/>
				小区ID：<input name="communityId" value="3"><br/>
				楼号：<input name="buildingNo" value="01"><br/>
				房号：<input name="roomNo" value="三单元201"><br/>
				<input type="submit" value="提交">
			</form>
			
			<h1>上传文件测试</h1>
			<form method="POST" enctype="multipart/form-data" action="http://localhost:8080/ownerClient/api/files/uploadFile.shtml">
			  File to upload:
			...
			<h1>下载文件测试</h1>
			<form method="POST" enctype="multipart/form-data" action="http://localhost:8080/ownerClient/api/files/outFile.shtml">			 
			  <input type="text" name="first" value="/2015/10/31/Bu8sd3fx5Ki8VR4JuTz832fiNEcL3Rwg.jpg"><br/>
			  <input type="text" name="token" value="z8vtBSr0aehkHhhcvTWF7eaSVR4uoP87"><br/>
			  <input type="text" name="title" value="优秀教师"><br/>
			...
			<h1>用户认证添加小区</h1>
			<form action="http://localhost:8080/ownerClient/api/lawyer/addCommunity.shtml" method="post">
				<input name="token" value="99cd099a977d4a398bde7865aae6c31e"><br/>
				名称：<input name="name" value="光明顶"><br/>
				省ID：<input name="provinceId" value="1"><br/>
				市ID：<input name="cityId" value="2"><br/>
				区/县ID：<input name="regionId" value="3"><br/>
				<input type="submit" value="提交">
			</form>
			
			
			<h1>根据地区获取小区列表</h1>
			<form action="http://localhost:8080/ownerClient/api/lawyer/findCommunity.shtml" method="post">
				<input name="token" value="99cd099a977d4a398bde7865aae6c31e"><br/>
				省/直辖市/地区ID：<input name="provinceId" value=""><br/>
				市ID：<input name="cityId" value=""><br/>
				区ID：<input name="regionId" value=""><br/>
				<input type="submit" value="提交">
			</form>
			
			
			<h1>获取地区列表</h1>
			<form action="http://localhost:8080/ownerClient/api/CUserAccount/findArea.shtml" method="post">
				<input name="token" value="99cd099a977d4a398bde7865aae6c31e"><br/>
				父地区ID：<input name="parentId" value=""><br/>
				<input type="submit" value="提交">
			</form>
			
			
			<h1>获取对第三方的评论</h1>
			<form action="http://localhost:8080/ownerClient/api/government/findComment.shtml" method="post">
				<input name="token" value="99cd099a977d4a398bde7865aae6c31e"><br/>
				第三方UID：<input name="destinationUid" value="724208361"><br/>
				<input type="submit" value="提交">
			</form>
			

			<h1>对第三方进行评论</h1>
			<form action="http://localhost:8080/ownerClient/api/government/addComment.shtml" method="post">
				<input name="token" value="99cd099a977d4a398bde7865aae6c31e"><br/>
				业主UID：<input name="uid" value="688046581"><br/>
				第三方UID：<input name="destinationUid" value="724208361"><br/>
				评论内容：<input name="content" value="第三方挺好的！~"><br/>
				<input type="submit" value="提交">
			</form>
			...
			<form action="http://localhost:8080/ownerClient/api/government/findComment.shtml" method="post">
				<input name="token" value="99cd099a977d4a398bde7865aae6c31e"><br/>
				政府UID：<input name="destinationUid" value="707901881"><br/>
				<input type="submit" value="提交">
			</form>
			...
			<form action="http://localhost:8080/ownerClient/api/government/addComment.shtml" method="post">
				...
				业主UID：<input name="uid" value="688046581"><br/>
				政府UID：<input name="destinationUid" value="707901881"><br/>
				评论内容：<input name="content" value="政府挺好的！~"><br/>
				<input type="submit" value="提交">
			</form>
			
			
			<h1>获取对监委会的评论</h1>
			<form action="http://localhost:8080/ownerClient/api/OCommittee/findComment.shtml" method="post">
				<input name="token" value="99cd099a977d4a398bde7865aae6c31e"><br/>
				监委会UID：<input name="destinationUid" value="698942841"><br/>
				<input type="submit" value="提交">
			</form>
			

			<h1>对监委会进行评论</h1>
			<form action="http://localhost:8080/ownerClient/api/OCommittee/addComment.shtml" method="post">
				<input name="token" value="99cd099a977d4a398bde7865aae6c31e"><br/>
				业主UID：<input name="uid" value="688046581"><br/>
				监委会UID：<input name="destinationUid" value="698942841"><br/>
				评论内容：<input name="content" value="监委会挺好的！~"><br/>
				<input type="submit" value="提交">
			</form>
			...
			<form action="http://localhost:8080/ownerClient/api/ownersCommittee/findComment.shtml" method="post">
				<input name="token" value="99cd099a977d4a398bde7865aae6c31e"><br/>
				业委会UID：<input name="destinationUid" value="674920571"><br/>
				<input type="submit" value="提交">
			</form>
			

			<h1>对居委会进行评论</h1>
			<form action="http://localhost:8080/ownerClient/api/nCommittee/addComment.shtml" method="post">
				<input name="token" value="99cd099a977d4a398bde7865aae6c31e"><br/>
				业主UID：<input name="uid" value="688046581"><br/>
				居委会UID：<input name="destinationUid" value="674920571"><br/>
				评论内容：<input name="content" value="居委会挺好的！~"><br/>
				<input type="submit" value="提交">
			</form>
			
			<img alt="显示图片" width="200px" height="200px" src="E:\2012100413195471481.jpg">
